          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              <g
                ...
                style={{ transform: "scale(1.05) translate(-7px, 160px)" }}
              >
                <defs>
                  <path
                ...
                <g
                  id="Clothing/Graphic/Luffy"
                  mask="url(#react-mask-718)"
                  fillRule="evenodd"
                  fill="#FFFFFF"
                >
                  <g id="Fill-49" style={{ transform: "translate(43%, 22%)" }}>
                    <path
                      xmlns="http://www.w3.org/2000/svg"
                      fillRule="evenodd"
              ...
              >
                <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                  ...
                  <use
                    ...
                    fill="#000000"
                    fillRule="evenodd"
                    xlinkHref="#react-path-551"
                  />
                  <rect
                    id="Teeth"
                    fill="#FFFFFF"
                    fillRule="evenodd"
                    mask="url(#react-mask-552)"
                    x="39"
                    y="2"
                    width="31"
                    height="16"
                  ...
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    >
                      ...
                      <mask id="react-mask-697" fill="white">
                        <use xlinkHref="#react-path-698" />
                      </mask>
                      <use
                        id="Lite-Beard"
                        fill="#331B0C"
                        fillRule="evenodd"
                        xlinkHref="#react-path-698"
                      />
                      <g
                        id="Color/Hair/Brown"
                        mask="url(#react-mask-697)"
                        fill="#2C1B18"
                      >
                        <g
                    ...
                    >
                      ...
                      <g transform="translate(48.000000, 3.000000)">
                        <mask id="react-mask-666" fill="white">
                          <use xlinkHref="#react-path-669" />
                        </mask>
                        <use
                          id="Turban-Mask"
                          fill="#124C74"
                          xlinkHref="#react-path-669"
                        />
                        <g
                          id="Color/Palette/Gray-01"
                          mask="url(#react-mask-666)"
                          fillRule="evenodd"
                          fill="#262E33"
                        >
                          <rect
